...
public class ArithmeticParser implements ArithmeticParserConstants {
  ...
  final public int Expression() throws ParseException {int left, right;
    Token op;
    left = Term();
    label_1:
    while (true) {
...
{if ("" != null) return left;}
  ...
  final public int Term() throws ParseException {int left, right;
    Token op;
    left = Factor();
    label_2:
    while (true) {
...
{if ("" != null) return Integer.parseInt(t.image);}
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0xc,0xc,0x30,0x30,0x4a,};
	}
